...
Ref: https://networkx.org/documentation/stable/auto_examples/algorithms/plot_betweenness_centrality.html#sphx-glr-auto-examples-algorithms-plot-betweenness-centrality-py
"""

def btwcentrality_wormnet():
    ...
    G = nx.read_edgelist("/Volumes/mmt_external/dais24/ext_vols/wormnet/WormNet.v3.benchmark.txt")
